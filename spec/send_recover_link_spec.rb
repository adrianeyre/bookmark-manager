...
describe SendRecoverLink do
  let(:user) { double :user, email: 'test@test.com', password_token: '1234567' }
  ...
  it 'sends a message to mailgun when it is called' do
    params = { from: 'bookmarkmanager@mail.com',
               ...
               text: "click here to reset your password https://joes-bookmark-manager.herokuapp.com/links/reset_password?token=#{user.password_token}" }
